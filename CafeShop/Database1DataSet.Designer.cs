...
namespace CafeShop {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class managerDataTable : global::System.Data.TypedTableBase<managerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public managerRow AddmanagerRow(string name, string pass) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public managerRow FindByname(string name) {
...
namespace CafeShop.Database1DataSetTableAdapters {
    ...
    public partial class managerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[manager] WHERE (([name] = @Original_name) AND ([pass] = @Origi" +
                "nal_pass))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[manager] ([name], [pass]) VALUES (@name, @pass);\r\nSELECT name," +
                " pass FROM manager WHERE (name = @name)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[manager] SET [name] = @name, [pass] = @pass WHERE (([name] = @Origi" +
                "nal_name) AND ([pass] = @Original_pass));\r\nSELECT name, pass FROM manager WHERE " +
                "(name = @name)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT name, pass FROM dbo.manager";
        ...
        public virtual int Delete(string Original_name, string Original_pass) {
        ...
        public virtual int Update(string name, string pass, string Original_name, string Original_pass) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string pass, string Original_name, string Original_pass) {
            return this.Update(Original_name, pass, Original_name, Original_pass);
        }
    }
